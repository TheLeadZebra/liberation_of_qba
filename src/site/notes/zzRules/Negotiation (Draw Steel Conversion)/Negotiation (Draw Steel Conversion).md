---
{"dg-publish":true,"permalink":"/zz-rules/negotiation-draw-steel-conversion/negotiation-draw-steel-conversion/"}
---
...
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#When to Negotiate\|When to Negotiate]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Limits of Negotiation\|Limits of Negotiation]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#The Threat of Violence\|Threat of Violence]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Negotiation Stats\|Negotiation Stats]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest\|Interest]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Patience\|Patience]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Language and Patience\|Language and Patience]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Motivations\|Motivations]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Pitfalls\|Pitfalls]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#List of Motivations and Pitfalls\|List of Motivations and Pitfalls]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Benevolence\|Benevolence]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Discovery\|Discovery]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Freedom\|Freedom]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Greed\|Greed]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Higher Authority\|Higher Authority]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Justice\|Justice]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Legacy\|Legacy]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Peace\|Peace]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Power\|Power]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Protection\|Protection]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Revelry\|Revelry]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Vengeance\|Vengeance]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Opening a Negotiation\|Opening a Negotiation]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Stop Combat, Start Negotiation\|Stop Combat, Start Negotiation]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Starting Stats\|Starting Stats]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Negotiation Starting Attitudes Table\|Negotiation Starting Attitudes Table]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Uncovering Motivations\|Uncovering Motivations]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Outside of Negotiation\|Outside of Negotiation]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Making Arguments\|Making Arguments]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Appeal to Motivation\|Appeal to Motivation]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#No Motivation or Pitfall\|No Motivation or Pitfall]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Caught in a Lie\|Caught in a Lie]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Pitfall Used\|Pitfall Used]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Renown and Negotiation\|Renown and Negotiation]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Fame or Infamy?\|Fame or Infamy]]
		- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Influencing Tests\|Influencing Tests]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#NPC Response and Offer\|NPC Response and Offer]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest 6 ("Yes, and...")\|Interest 6 ("Yes, and...")]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest 5 ("Yes.")\|Interest 5 ("Yes.")]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest 4 ("Yes, but...")\|Interest 4 ("Yes, but...")]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest 3 ("No, but...")\|Interest 3 ("No, but...")]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest 2 ("No.")\|Interest 2 ("No.")]]
	- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Interest 1 ("No, and...")\|Interest 1 ("No, and...")]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Keep Going or Stop\|Keep Going or Stop]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Draw Steel Test Types (For reference)\|Draw Steel Test Types (For reference)]]
- [[zzRules/Negotiation (Draw Steel Conversion)/Negotiation (Draw Steel Conversion)#Sample Negotiation\|Sample Negotiation]]
...
Heroes aren't expected to use the negotiation rules every time one character tries to convince an NPC to see things their way. For instance, if a hero wants information about a cult leader from a captured cultist, a single Charisma test using the Deception skill or a Strength test using Intimidation is likely all that's needed. A character who wants to flirt with the local alchemist to obtain a free Healing Potion likely just needs to make a Charisma test using the Persuasion skill.
...
Negotiation is about persuading someone to help you willingly because you've convinced them that meeting your objectives is a good idea. Working with you is wise or logical, or might make them look good. A hero can absolutely threaten someone with violence and force them to do what they want, but this is an incredibly temporary state. A threatened NPC isn't willingly doing what they've been asked. They're doing it on threat of violence, and will comply only while that threat is evident—after which, they'll likely go back to their previous behaviour as soon as they think they can get away with it.

### Negotiation Stats

During negotiation, the Director assigns NPCs four temporary statistics and features—interest, patience, motivations, and pitfalls. The heroes can strike a favourable deal if they maximize an NPC's interest by making arguments that invoke the NPC's motivations and avoid their pitfalls—but they have to do all that before the NPC's patience wears out.
...
An NPC can have any of the following twelve motivations or pitfalls, as well as any other that the Director deems.
...
If a hero wants to halt hostilities to negotiate with the other side, they can use a manoeuvre to make a hard Charisma test (or another applicable test, as the Director determines) in an attempt to stop combat and start a negotiation. The test has a chance of success only if the Director believes the other side is willing and capable of negotiating. A foe who has the upper hand, who hates the heroes beyond measure, or who lacks sapience is unlikely to negotiate.
...
| ---------- | -------------------------------------------------------------------------------------------------------- | -------- | -------- |
| Hostile    | Openly opposed to the heroes. Barely willing to listen.                                                  | 2        | 3        |
| Suspicious | Doubts the heroes' motives but is willing to listen.                                                     | 3        | 3        |
| Neutral    | Doesn't feel one way or the other. Would probably rather be somewhere else, but doesn't want to be rude. | 3        | 4        |
| Open       | Willing to listen, willing to help, as long as the heroes aren't asking too much.                        | 4        | 4        |
| Friendly   | The heroes seem like the NPC's people. The NPC is willing to give them the benefit of the doubt.         | 4        | 5        |
| Trusting   | The NPC has reason to take the heroes at their word and will help if the characters don't screw this up. | 4        | 6        |
...
If an NPC isn't as forthcoming, or if the heroes want to learn one of the NPC's pitfalls, a hero can make an Intelligence, Wisdom, or Charisma test while interacting with the NPC during the negotiation, based on the tactics used to draw out the NPC. The test has the following outcomes:
...
**Power Roll + Wisdom, Intelligence, or Charisma:**
...
> 
> Since Wisdom and Intelligence with creatively applied skills can be used to make arguments, all heroes can actively participate in the process of negotiation. The hero with the highest Charisma who has best the Persuasion skill doesn't automatically have to be the one who makes all the tests.
...
If a hero is famous to an NPC, they gain an edge on tests when making arguments to which Charisma skills could be applied. If they are infamous to the NPC, they gain an edge on tests when making arguments to which Strength skills could be applied. A hero gains this edge even if they are not proficient in the appropriate skill.
...
The initial response should come with an offer (or a refusal to make an offer) based on the NPC's current interest. If a hero's argument reduces an NPC's patience to 1, the NPC lets the heroes know that this is their final offer.

#### Interest 6 ("Yes, and...")

If the NPC's interest is 6, they offer everything the heroes initially asked for—and then sweeten the deal. This represents the best possible outcome for the heroes. If they offered to perform any services or make payments as part of the deal, the NPC might waive those obligations, allowing the heroes to get what they want for free. Alternatively, the NPC might hold the heroes to any offers they made and instead offer an extra service or item on top of what was asked for.
...
If the NPC's interest is 5, they offer the heroes everything they asked for but won't sweeten the deal. The NPC also accepts anything the heroes have offered as part of the deal with this outcome.
...
If the NPC's interest is 4, they offer the heroes what they want in exchange for everything the heroes offered... then they ask for a little extra, such as a favour or a payment from the characters. If the heroes offered to free a thieves' guild member from prison in exchange for the service of the organization's assassins, the guildmaster might ask them to free an additional prisoner, or to grant the prisoner they rescue a sum of cash or a magic weapon.

#### Interest 3 ("No, but...")

If the NPC's interest is 3, the NPC can't give the heroes what they want. However, they are willing to offer other less impactful goods or services in exchange for whatever the heroes have promised. The guildmaster might not be willing to spare any troops to fight Lord Saxton, but could instead offer the latest spy reports on Saxton's movements in exchange for the jailbreak.

#### Interest 2 ("No.")

If the NPC's interest is 2, they outright reject the heroes' idea without a counteroffer. If the NPC still has patience, they might press the heroes for a better deal, saying something like, "Why should we risk our necks to help you fight Lord Saxton? What's really in it for the thieves' guild, other than a short, brutal end when you inevitably fail?"

#### Interest 1 ("No, and...")

If an NPC's interest is 1, they offer nothing, refuse to negotiate further, and seek to harm the heroes. The NPC might attack immediately, or they could take a different approach, perhaps spreading malicious rumors about the characters, sending assassins after them, or otherwise making their lives difficult. If the heroes don't want to be at odds with the NPC, they'll need to offer a valuable gift or undertake a quest just to make amends.

It is impossible to continue a negotiation when an NPC's interest drops to 1.

### Keep Going or Stop

If an NPC still has patience after making an offer and their interest is between 2 and 5, the heroes can make another argument to attempt to improve the deal. Alternatively, they can accept the offer and end the negotiation. Let the players drive this decision. You can always have an NPC show they have patience remaining by asking, "Is there anything else?"

If the NPC's patience is 1 or their interest is 6, then the offer the NPC makes is their final offer to the characters. The heroes can accept the offer or not, but either way, the negotiation ends.

If the NPC's interest is 1, the NPC ends the negotiation without accepting a deal. The heroes can walk away from a negotiation without accepting a deal at any time.
...
An easy test has some risk of consequence, but most heroes will likely overcome it. The power roll you make for an easy test determines the outcome:
...
Korvo inadvertently made an argument using a pitfall by appealing to a higher authority. The Director notes that Zola's interest drops to 2 and her patience drops to 4. Zola gave a pretty firm "No" response here, which is what an NPC with an interest of 2 would say. However, the Director phrased Zola's response in such a way that the heroes know they can keep making arguments if they wish, since her patience hasn't run out.
...
Because Linn appealed to a motivation, Zola's interest increases to 3, and her patience drops to 3. The Director gives a "No, but..." response based on Zola's interest. At this point, the heroes haven't promised anything, so she offers them something for free.
...
Because Jorn appealed to a motivation, Zola's interest increases to 4, and her patience is reduced to 2. The Director gives a "Yes, but..." response while making it clear that the negotiation can still continue.
